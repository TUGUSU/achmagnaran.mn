...
const advantages = [
  {
    ...
    desc: 'Гахайн махны салбарт зах зээлийн 20 гаруй хувийг эзэлдэг бөгөөд Монголын мах боловсруулах үйлдвэрлэлд тасралтгүй 12 жил ажиллаж байна.',
  },
  {
  ...
  {
    title: '4 нэрийн дэлгүүр',
    desc: 'Бөмбөгөр худалдааны төв, Номин сүлжээний дэлгүүрүүдэд өөрийн 4 брэнд салбараар үйлчилж байна.',
  },
  {
  ...
  },
  {
    ...
    desc: 'ОХУ-н Сибагро, Мироторг болон БНХАУ-н 2 үйлдвэртэй гэрээт хамтын ажиллагаатай.',
  },
  {
...
const qualityPoints = [
  ...
  },
  {
    ...
    desc: 'Зориулалтын хөргөлттэй тээврийн хэрэгслээр бүтээгдэхүүнийг тээвэрлэж температурын нөхцөлийг алдагдуулалгүй цаг хугацааны дотор хүргэдэг.',
  },
  {
    num: '06',
    title: 'Нитритгүй  болон хугацаа уртасгагчгүй бүтээгдэхүүнүүд',
    desc: 'Зайдас болон бүтээгдэхүүнүүд нитрит агуулалгүй технологиор үйлдвэрлэдэг тул хэрэглэгчийн эрүүл мэндэд сөрөг нөлөөгүй.',
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="flex flex-col gap-8">
              ...
              <p className="text-cream-muted text-[15px] leading-[1.85] scroll-reveal" style={{ transitionDelay: '0.08s', textAlign: 'justify' } as React.CSSProperties}>
                ...
                бүрийн аюулгүй байдал, ариун цэвэр, тогтмол чанар нь бидний хамгийн тэргүүлэх зорилт юм.
              </p>
