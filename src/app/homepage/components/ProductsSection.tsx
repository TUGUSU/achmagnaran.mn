...
const ALL_PRODUCTS: Product[] = [
  {
    ...
    detailDesc:
      'Нитрит болон хугацаа уртасгагч агуулаагуй тул эрүүл мэндэд сөрөг нөлөөгүй. Франкфуртер зайдас нь Германы уламжлалт жорын дагуу боловсруулсан, үхэр болон гахайн махаар үйлдвэрлэгдсэн дээд зэргийн чанартай зөөлөн, жигд бүтэцтэй бүтээгдэхүүн юм.. Грилдэх болон шарах, жигнэх аргаар болгож хэрэглэхэд тохиромжтой тул өдөр тутмын хэрэглээ болон түргэн хоолны шийдэлд төгс нийцнэ.',
    suitableFor: ['Өрхийн хэрэглээ', 'Ресторан, кафе', 'Арга хэмжээ', 'Аялал зугаалга'],
    storageNote: '0–18°C-д хадгална.',
    productType: 'ОХУ, Монгол',
    origin: 'Монгол',
  ...
  },
  {
    ...
    detailDesc:
      'Нитрит болон химийн нэмэлт бодис агуулаагүй, зөвхөн гахайн мах, байгалийн гаралтай амтлагчаар боловсруулсан зайдас. Байгалийн цэвэр бүтээгдэхүүнийг эрхэмлэдэг хэрэглэгчдэд тохиромжтой бөгөөд зөөлөн амт, энгийн орц нь өдөр тутмын хэрэглээ, тэр дундаа хүүхэд хэрэглэхэд тохиромжтой. Грилдэх болон шарах, жигнэх аргаар болгож хэрэглэхэд тохиромжтой тул өдөр тутмын хэрэглээ болон түргэн хоолны шийдэлд төгс нийцнэ.',
    suitableFor: ['Өрхийн хэрэглээ', 'Ресторан, кафе', 'Арга хэмжээ', 'Аялал зугаалга'],
    storageNote: '0–18°C-д хадгална.',
    productType: 'ОХУ',
    origin: 'Монгол',
  ...
  },
  {
    ...
    detailDesc:
      'Утсан гахайн мах нь алимны модны үртэсээр утаж боловсруулдаг тул өвөрмөц утаат үнэр, баялаг амттай болдог. Өглөөний цай, BBQ болон паста, зууш зэрэгт хэрэглэвэл тохиромжтой, гэр бүлийн бүх гишүүдэд зориулагдсан.',
    suitableFor: ['Өрхийн хэрэглээ', 'Ресторан, кафе', 'Арга хэмжээ', 'Аялал зугаалга'],
    storageNote: '0–18°C-д хадгална.',
    productType: 'ОХУ',
    origin: 'Монгол',
  ...
  },
  {
    ...
    detailDesc:
      'Гахайн хуйхгүй цоройн махаар бэлтгэсэн, урьдчилан ангилсан жигд зүсэлттэй тул шууд хэрэглэхэд бэлэн, цаг хэмнэх хялбар шийдэл, зөөлөн бүтэц, тогтвортой амттай. Өдөр тутмын хоол болон аялал зугаалгад тохиромжтой бөгөөд шарах, хуурах, жигнэх, гриллдэх зэрэгт ашиглах боломжтой.',
  ...
  },
  {
    ...
    detailDesc:
      'Гахайн цоройн мах бөгөөд нэмэлт амталгаагүй хэрэглэгч өөрийн дуртай жор, амталгааны дагуу  боловсруулж, өдөр тутмын хоол болон шарж хэрэглэхэд тохиромжтой. Өөх, махны давхарга тэнцвэртэй тул шарахад гадна талаараа шаржигнасан, дотроо шүүслэг, зөөлөн бүтэцтэй болдог. Махны цэвэр амт, чанарыг хадгалсан тул гэрийн хоол болон зочин дайлахад ч тохиромжтой, найдвартай сонголт юм.',
  ...
  },
  {
    ...
    detailDesc:
      'Гахайн цоройн мах бөгөөд нэмэлт амталгаагүй хэрэглэгч өөрийн дуртай жор, амталгааны дагуу  боловсруулж, өдөр тутмын хоол болон шарж хэрэглэхэд тохиромжтой. Өөх, махны давхарга тэнцвэртэй тул шарахад гадна талаараа шаржигнасан, дотроо шүүслэг, зөөлөн бүтэцтэй болдог. Махны цэвэр амт, чанарыг хадгалсан тул гэрийн хоол болон зочин дайлахад ч тохиромжтой, найдвартай сонголт юм./Байгууллага болон хувь хүн их хэмжээгээр авахад тохиромжтой./',
    suitableFor: ['Өрхийн хэрэглээ', 'BBQ шарсан хоол', 'Аялал зугаалга', 'Арга хэмжээ'],
    storageNote: '0–18°C-д хадгална.',
    productType: 'ОХУ',
    origin: 'Монгол',
    ingredients: 'Гахайн цоройн мах',
  },
  {
    ...
    detailDesc:
      'Тослог багатай, өдөр тутмын хоолонд тохиромжтой. Ресторан, албан байгууллага болон гэр бүлийн хэрэглээнд нийцсэн, шарах, чанах, жигнэхэд тохиромжтой мах. /Байгууллага болон хувь хүн их хэмжээгээр авахад тохиромжтой./',
    suitableFor: ['Өрхийн хэрэглээ', 'BBQ, шарсан хоол', 'Аялал зугаалга', 'Арга хэмжээ'],
    storageNote: '0–18°C-д хадгална.',
    productType: 'ОХУ',
    origin: 'Монгол',
  ...
  },
  {
    ...
    detailDesc:
      'Тахианы шүүслэг, амтлаг бөгөөд шарах, жигнэх зэрэг бүх төрлийн хоолонд тохиромжтой, өргөн хэрэглээний мах юм. Мөн амьтныг халал аргаар бэлтгэсэн, органик, антибиотикгүй түүхий эдээр үйлдвэрлэгдсэн тул хэрэглэгчдэд илүү аюулгүй, чанартай сонголт юм.',
    suitableFor: ['Өрхийн хэрэглээ', 'Арга хэмжээ'],
    storageNote: '0–18°C-д хадгална.',
    productType: 'БНХАУ',
    origin: 'БНХАУ',
    ingredients: 'Тахиан бугалга',
  },
  {
    id: 10,
    name: 'Тахианы гуя',
    ...
    detailDesc:
      'Тахиан гуяны мах нь яс, өөх махны зохистой харьцаатай тул шүүслэг амттай бөгөөд шарах, жигнэх, грилл хийхэд тохиромжтой.Мөн амьтныг халал аргаар бэлтгэсэн, органик, антибиотикгүй түүхий эдээр үйлдвэрлэгдсэн тул хэрэглэгчдэд илүү аюулгүй, чанартай сонголт юм.',
    suitableFor: ['Өрхийн хэрэглээ', 'Арга хэмжээний'],
    storageNote: '0–18°C-д хадгална.',
    productType: 'БНХАУ',
    origin: 'БНХАУ',
    ingredients: 'Тахиан гуяны мах',
  },
  {
    id: 11,
    name: 'Тахиан мөч',
    ...
    detailDesc:
      'Тахианы мөч нь яс, махны зохистой харьцаатай тул шүүслэг амттай бөгөөд шарах, жигнэх, грилл хийх зэрэгт нэн тохиромжтой, өргөн хэрэглээний мах юм. Мөн амьтныг халал аргаар бэлтгэсэн, органик, антибиотикгүй түүхий эдээр үйлдвэрлэгдсэн тул хэрэглэгчдэд илүү аюулгүй, чанартай сонголт юм.',
    suitableFor: ['Өрхийн хэрэглээ', 'Арга хэмжээ'],
    storageNote: '0–18°C-д хадгална.',
    productType: 'БНХАУ',
    origin: 'БНХАУ',
    ingredients: 'Тахиан мөч',
  },
  {
    id: 12,
    ...
    detailDesc:
      'Тахиан гуяны цул мах нь ясгүй, зөөлөн бүтэцтэй бөгөөд өөх, махны тэнцвэртэй харьцаатай тул шүүслэг,  амттай. Шарах, жигнэх, хуурах зэрэг бүх төрлийн хоолонд тохиромжтой, амтлагчийг сайн шингээдэг давуу талтай. Мөн амьтныг халал аргаар бэлтгэсэн, органик, антибиотикгүй түүхий эдээр үйлдвэрлэгдсэн тул хэрэглэгчдэд илүү аюулгүй, чанартай сонголт юм.',
    suitableFor: ['Гэр бүлийн хоол', 'Албан байгууллага', 'Том хэмжээний захиалга'],
    storageNote: '0–18°C-д хадгална.',
    productType: 'БНХАУ',
    origin: 'БНХАУ',
    ingredients: 'Тахиан гуяны цул мах',
  },
  {
    id: 13,
    name: 'Тахианы цээж',
    ...
    detailDesc:
      'Тахиан цээж мах нь өөх тос багатай,  уурагын агууламж өндөр  тул хөнгөн, эрүүл хооллолтод нэн тохиромжтой. Зөөлөн бүтэцтэй, амтлагчийг сайн шингээдэг учир шарах, жигнэх, чанах зэрэг бүх төрлийн хоолонд өргөн хэрэглэгддэг. Мөн амьтныг халал аргаар бэлтгэсэн, органик, антибиотикгүй түүхий эдээр үйлдвэрлэгдсэн тул хэрэглэгчдэд илүү аюулгүй, чанартай сонголт юм.',
    suitableFor: ['Өрхийн хэрэглээ', 'Арга хэмжээ'],
    storageNote: '0–18°C-д хадгална.',
    productType: 'БНХАУ',
    origin: 'БНХАУ',
    ingredients: 'Тахиан цээж мах',
  },
  {
    id: 14,
    ...
    detailDesc:
      'Халуун чинжүү болон байгалийн амтлагчаар амталж бэлдсэн гахайн цоройн мах нь өөх, махны төгс зохицолтой тул шарахад гадна талаараа шаргалтаж, дотроо шүүслэг, чихэрлэг зөөлөн бүтэцтэй болдог. Амтлагч нь маханд жигд шингэж, баялаг, тэнцвэртэй амтыг бүрдүүлдэг бөгөөд грилл болон хайруулын тавганд шарахад нэн тохиромжтой. Чанарын өндөр шаардлага хангасан, аюулгүй эх үүсвэрээс сонгосон түүхий эдийг хүнсний стандартын дагуу боловсруулсан тул хэрэглэгчдэд найдвартай, дээд зэрэглэлийн сонголт болно.',
    suitableFor: ['Аялал зугаалга', 'BBQ шарсан хоол', 'Өрхийн хэрэглээ'],
    storageNote: '0–18°C-д хадгална.',
    productType: 'ОХУ',
    origin: 'Монгол',
    ingredients: 'Гахайн цоройн мах, халуун чинжүү, байгалийн амтлагч',
  },
  {
    id: 15,
    name: 'Жэюүг',
    ...
    suitableFor: ['Өрхийн хэрэглээ', 'Аялал зугаалга', 'Арга хэмжээ'],
    storageNote: '0–18°C-д хадгална.',
    productType: 'ОХУ',
    origin: 'Монгол',
  ...
  },
  {
    ...
    detailDesc:
      'Гахайн хүзүүний махыг  амталж бэлтгэсэн бөгөөд өөх, махны зохистой харьцаатай тул шарахад гадна талдаа жигд борлон, дотроо шүүслэг зөөлөн бүтэцтэй болдог, бэлтгэж хэрэглэхэд хялбар бүтээгдэхүүн.',
  ...
  },
  {
    ...
    detailDesc:
      'Тусгай жороор урьдчилан амталж бэлтгэсэн моксал нь өөх, махны зохистой хослолтой тул шарахад гадна талаараа шаржигнасан, дотроо шүүслэг, зөөлөн бүтэцтэй болдог. Бэлэн амталсан тул нэмэлт орц, бэлтгэл шаардлагагүйгээр шууд болгож хэрэглэхэд тохиромжтой. Түргэн хугацаанд амттай хоол бэлтгэх боломжийг олгодог энэ бүтээгдэхүүн нь гэрийн хэрэглээ, BBQ болон ресторан, кафе зэрэгт өргөн ашиглахад нийцсэн сонголт юм.',
    suitableFor: ['Өрхийн хэрэглээ', 'Аялал зугаалга', 'Арга хэмжээ', 'BBQ шарсан хоол'],
    storageNote: '0–18°C-д хадгална.',
    productType: 'ОХУ',
    origin: 'Монгол',
  ...
  },
  {
    ...
    detailDesc:
      'Хамбагу стейк нь Япон технологийн дагуу үхэр, гахайн татсан махыг тусгай жороор амталж, жигд хэлбэрт оруулан бэлтгэсэн бөгөөд шарахад дотроо шүүслэг, зөөлөн бүтэцтэй болдгоороо онцлог. Урьдчилан амталж бэлэн болгосон тул нэмэлт бэлтгэл шаардлагагүйгээр шууд шараад хэрэглэхэд хялбар, богино хугацаанд амттай хоол бэлтгэх боломжийг бүрдүүлнэ. Өдөр тутмын хоолонд хэрэглэхээс гадна хамбургерийн мах, котлет болон BBQ аргаар боловсруулан ашиглахад тохиромжтой бүтээгдэхүүн юм.',
    suitableFor: ['Өрхийн хэрэглээ', 'Кафе, түргэн хоол', 'Арга хэмжээ', 'Аялал зугаалга'],
    storageNote: '0–18°C-д хадгална.',
    productType: 'ОХУ, Монгол',
    origin: 'Монгол',
    ingredients: 'Үхрийн мах, Гахайн мах, Амтлагч',
  },
  {
    id: 19,
    name: 'Хамбагу мини',
    ...
    detailDesc:
      'Хамбагу мини нь Япон технологоор үхэр, гахайн татсан махыг тусгай жороор амталж, жижиг бөөрөнхий хэлбэрт оруулан бэлтгэсэн бөгөөд шарахад гадна талаараа зөөлөн шаргал, дотроо шүүслэг, зөөлөн бүтэцтэй болдгоороо онцлог. Урьдчилан амталж бэлэн болгосон тул нэмэлт бэлтгэл шаардлагагүйгээр шууд шараад хэрэглэхэд хялбар, богино хугацаанд хоол бэлтгэх боломжийг олгодог. Гэрийн хэрэглээнд хүүхдийн болон өдөр тутмын хоолонд, ресторан, кафе-д салат, паста болон түргэн хоолонд ашиглахад тохиромжтой бүтээгдэхүүн юм.',
    suitableFor: ['Өрхийн хэрэглээ', 'Кафе, түргэн хоол', 'Арга хэмжээ', 'Аялал зугаалга'],
    storageNote: '0–18°C-д хадгална.',
    productType: 'ОХУ, Монгол',
    origin: 'Монгол',
  ...
  },
  {
    ...
    detailDesc:
      'Мантуутай гахай нь хятад жорийн дагуу амталж бэлтгэсэн гахайн махыг мантуутай хослуулан хэрэглэдэг бөгөөд амтны зохицол сайтай, идэхэд хялбар хоол юм. Богино хугацаанд бэлтгэж болох тул гэрийн хэрэглээ, ресторан, түргэн хоолонд ашиглахад тохиромжтой.',
    suitableFor: ['Өрхийн хэрэглээ', 'Ресторан', 'Арга хэмжээ', 'Аялал зугаалга'],
    storageNote: '0–18°C-д хадгална.',
    productType: 'ОХУ',
    origin: 'Монгол',
    ingredients: 'Гахайн цоройн мах, амтлагч , мантуу',
  },
  {
    id: 22,
    ...
    detailDesc:
      'Амталсан тахианы мах нь тахианы гуяны цул махыг солонгос маягаар тусгайлан амталж бэлтгэсэн шарахад зөөлөн, шүүслэг байдлаа хадгалдгаараа онцлог бүтээгдэхүүн юм. Халуун ногоо болон үл ялиг чихэрлэг амтны зохицол нь өвөрмөц, гүн амтыг бүрдүүлнэ. Урьдчилан амталсан тул нэмэлт бэлтгэл шаардлагагүй, богино хугацаанд амттай хоол бэлтгэхэд тохиромжтой. Өдөр тутмын хоолонд, мөн ресторан, кафе, шорлог, BBQ болон түргэн хоолны үйлчилгээнд ашиглахад нийцсэн бүтээгдэхүүн юм.',
    suitableFor: ['Өрхийн хэрэглээ', 'Арга хэмжээ', 'Аялал зугаалга'],
    storageNote: '0–18°C-д хадгална.',
    productType: 'БНХАУ',
    origin: 'Монгол',
              ...
              {visible.map((product, i) => {
                ...
                return (
                  <div
                    key={product.id}
                    ref={cardRef}
                    // ADDED: onClick and cursor-pointer so the whole card opens the modal
                    onClick={() => setSelected(product)}
                    className="product-card spotlight-card bg-warm-card rounded-sm border overflow-hidden card-glow product-card-enter cursor-pointer"
                    style={{
                  ...
                  >
                    ...
                    <div className="p-4 flex flex-col gap-3">
                      ...
                      >
                        ...
                        <button
                          // ADDED: prevent event bubbling so clicking the button doesn't trigger the card's onClick twice
                          onClick={(e) => {
                            e.stopPropagation();
                            setSelected(product);
                          }}
        ...
        >
          ...
          >
            ...
            <div className="p-6 md:p-8">
              ...
              {/* ADDED: Dynamic Grid columns based on whether it is a chicken category */}
              <div className={`grid ${selected.categoryKey === 'chicken' ? 'grid-cols-1' : 'sm:grid-cols-2'} gap-3 mb-5`}>
                <div
                ...
                {/* ADDED: Conditional rendering so this box is hidden if the category is chicken */}
                {selected.categoryKey !== 'chicken' && (
                  <div
                    className="p-3 rounded-sm"
                    style={{ backgroundColor: 'rgba(212,168,83,0.07)', border: '1px solid rgba(212,168,83,0.2)' }}
                  >
